...
//	ros::Publisher joint_cmd_pub  = n1.advertise<sensor_msgs::JointState>("/allegroHand_0/joint_cmd", 3);
 ...
 //	ros::Publisher jointcmd_pub = n1.advertise<sensor_msgs::JointState>("/allegroHand_1/joint_cmd", 1000);
 	ros::Publisher jointcmd_pub = n1.advertise<sensor_msgs::JointState>("/desired_hand_state", 1000);
...
//    ros::Subscriber joint_state_sub = n1.subscribe("/allegroHand_0/joint_states", 1, updateJointStates);
	...
	while(ros::ok())
	{
		...
		desired_joint_state.position[0] = 0 ;								//finger 1
		desired_joint_state.position[1] =  beta*snextpos_fingers[4] ;
		desired_joint_state.position[2] =  beta*snextpos_fingers[2] ;
		desired_joint_state.position[3] =  beta*snextpos_fingers[3] ;
		desired_joint_state.position[4] = 0;								//finger 2
		desired_joint_state.position[5] = beta*snextpos_fingers[4];
		desired_joint_state.position[6] = beta*snextpos_fingers[2];
		desired_joint_state.position[7] =  beta*snextpos_fingers[3];
		desired_joint_state.position[8] = 0;								//finger 3
		desired_joint_state.position[9] =  beta*snextpos_fingers[4];
		desired_joint_state.position[10] =  beta*snextpos_fingers[2];
		desired_joint_state.position[11] =  beta*snextpos_fingers[3];
		desired_joint_state.position[12] =  beta*snextpos_fingers[0];	//thumb
		desired_joint_state.position[13] =  beta*snextpos_fingers[1];
		desired_joint_state.position[14] =  beta*snextpos_fingers[2];
		desired_joint_state.position[15] =  beta*snextpos_fingers[3];
